...
- API keys for:
  - [Anthropic](https://console.anthropic.com/) (`ANTHROPIC_API_KEY`) — powers the query-building and answering agents
...
uv sync
cp .env.example .env
# then fill in ANTHROPIC_API_KEY, VOYAGE_API_KEY, DIP_API_KEY in .env
```
