...
- datum_start / datum_end: Datumsbereich (z. B. "seit dem 01.01.2026" -> datum_start=2026-01-01).
...
- drucksachetyp: nur für "drucksache", z. B. "Antrag", "Gesetzentwurf", "Kleine Anfrage".
...
- titel: nur für "drucksache", Suchbegriffe im Titel. Mehrere Werte werden ODER-verknüpft.

Wichtige Regeln:
- urheber, ressort_fdf und titel dürfen NUR gesetzt werden, wenn endpoint == "drucksache" ist.
- Wenn die Anfrage zu vage oder mehrdeutig ist, um sie sicher in diese Filter zu übersetzen \
(z. B. fehlendes Datum oder fehlende Wahlperiode bei einer sehr breiten Anfrage, oder ein \
unklarer Dokumenttyp), antworte NICHT mit einer Vermutung, sondern stelle stattdessen eine \
kurze, konkrete Rückfrage auf Deutsch.
